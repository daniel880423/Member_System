...
import os
def oldhomeworkstudentHtml(rows, hw_num):
    # 標題
    table = HTMLTable()
    # 表頭行
    ...
    <body style='background-color: #315e49;'>
        <table border="3" width="300px" height="100px" style="border-color:#555858;">
            <tr>
                <td bgcolor="#37464a">
                    <form action="/oldhomeworkteachingassistant/{hw_num}" style="display:inline-block;"><button class="but"style="font-size: 23px;">返回助教頁面</button></form>
                </td>
            </tr>
        </table>
        <div class='main'>
    ...
    # print(os.getcwd())
    # # print("--------------------------------")
    with open(f"templates/oldhomework{hw_num}studentdata.html", "w", encoding="utf-8") as file:
